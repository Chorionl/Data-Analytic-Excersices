...
-- first name ,last name se pio project douleyei
...
--first name last name project name se poio deparm (enoneis duo pinakes )
...
-- osous douleuoyn dep 3 kai exoun hire date 2022
...
-- na metriseis posoi doyleuoun it kai hr
...
left join departments
on employees.department_id=departments.department_id
where hire_date >= '2022-05-01'                                             --ÃÉÁÔÉ iNNER KAI OXI LEFT I TO ANTITHETO? 8-9QUESTION (NULL)
order by hire_date
...
-- 5. Total salary cost for departments with ID >= 2
...
-- 7. Count projects for departments except department 4 
...
-- 14. Total number of IT projects (department_id = 3)
 
 select count(*) from projects
 where department_id =3

-- 15. Projects per start year, only years with more than 2 projects
...
------------------------------
--Find the total salary of employees in the Marketing department.
